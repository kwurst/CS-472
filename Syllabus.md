*Version 2020-Spring-1.0, Revised 13 January 2020*
...
This course has a prerequisite of CS 254 Computer Organization and Architecture. A basic understanding of digital logic circuits, computer architecture, and assembly language programming is useful for more advanced robotics topics, such as may be needed in the final project.

This course has a prerequisite of CS 282 UNIX Systems Programming. I expect you to be able to write programs of intermediate difficulty in the C programming language.
...
This course will introduce the student to behavior-based robotics and engineering design. Basic mechanical concepts such as drive-trains and gear reduction will be taught. Control strategies and their programming (including multi-processing) will be covered.
...
This course addresses the following outcomes of the Computer Science Major (see [https://catalog.worcester.edu/undergraduate/school-education-health-natural-sciences/computer-science/major-computer-science/](https://catalog.worcester.edu/undergraduate/school-education-health-natural-sciences/computer-science/major-computer-science/)):
...
Lab Attendance: Weeks 10-16 | 7 (out of 7) | 6 (out of 7) | 5 (out of 7) | 4 (out of 7)
*Vehicles* Readings Summaries:<br>Introduction, Vehicles 1, 2, and 3 | All | All | All | All
*Vehicles* Readings Summaries: Vehicles 4-14 | 7 (out of 11)| 5 (out of 11) | 3 (out of 11) | 1 (out of 11)
...
Engineering Design Notebook Entries:<br>Weeks 10-16 | 4 (out of 7) | 3 (out of 7) | 2 (out of 7) | 1 (out of 7)
Final Project Proposal | &#10004; | &#10004; | &#10004; | &#10004;
Final Project Presentation | &#10004; | &#10004; | &#10004; | &#10004;
Robotics Exhibit/Concert<br>Description and Impressions | &#10004; | &#10004; | &#10004; |
Robotics Exhibit/Concert<br>Analysis of Robotics Elements | &#10004; | &#10004;
Robotics Technology in Everyday Life | 5 | 4 | 3 | 2
A-Grade Paper:<br>- Robotics Exhibit/Concert: What you would do differently <br> *OR* <br> - Dr. Oliver Lecture: Relate to *Vehicles* and Brooks [1986]| &#10004;
...
* You will have a ***plus*** modifier applied to your base grade if you have a total of 3 (or more) of the following at the end of the semester:
	...
	* Additional Weeks 10-16 Design Notebook Entries (beyond the requirements for your base grade)
...
* Arriving late and leaving early (unless you have finished and shown your work to the instructor) will result in your work being considered "Does Not Meet Specification" for that lab session.
* Working on things that are not part of the work for this class during class time will result in your work being considered "Does Not Meet Specification" for that lab session.

## Readings Summaries

You will be reading chapters from *Vehicles* by Braitenberg, as well as 2 journal articles about robotics.
...
* Everyone working to earn a passing grade must complete summaries of both journal articles.
...
*A more complete specification for "Meets Specification" (passing) summaries will be given during the semester.*
...
* Everyone working to earn a passing grade must complete a differing number of notebook entries for weeks 10-16 of the semester. See the table under *Course Grade Determination*.
    * I will only accept one notebook entry for weeks 10-16 per week. **You cannot wait until the end of the semester and then turn in all of your notebook entries.**

*A more complete specification for "Meets Specification" (passing) engineering design notebook entries will be given during the semester.*

## Final Project
For the last portion of the semester, each group will pick a project to complete and demonstrate to the class. The project must be chosen in consultation with the instructor and approved by the instructor. The final project demonstrations and presentations will be given during the scheduled Final Exam period on Thursday, 14 May 2020, 8:30-11:30am

* Everyone working to earn a passing grade must submit a "Meets Specification" final project proposal and give a "Meets Specification" final project presentation.

*A more complete specification for an "Meets Specification" (passing) final project and presentation will be given during the semester.*

## Robotics Exhibit/Concert
I am looking for an art exhibit or concert (or something similar) that uses robotics technology.
* Anyone working to earn a grade of C or higher must attend this (possibly virtually), and write up a summary of contents of the exhibit/concert and your impressions of the exhibit/concert.
* Anyone working to earn a grade of B or higher must also analyze the robotics elements of the pieces in the exhibit/concert, talking about the hardware (sensors and effectors) used, and how you think the software works. You should include pictures of the robotics hardware in the exhibit/concert.

*A more complete specification for a "Meets Specification" (passing) visit report and exhibit/concert analysis will be given during the semester.*

## Robotics Technology in Everyday Life

Robotics technology is in use all around us, in things we don't often think of as robots. Anything that has sensors and effectors, that changes its behavior or state based on sensor input, and manipulates the world around itself with effectors, can be considered a robot.

As you go about your everyday life, look at machines that you see and interact with, and think about what sensors and effectors it has, and what kind of control strategy or software it may use.
...
*A more complete specification for "Meets Specification" (passing) analyses will be given during the semester.*

## A-Grade Paper

Anyone working to earn a grade of A will be required to write a paper. There are two options for this paper:

* Robotics Exhibit/Concert: What you would do differently. &mdash; with your new-found knowledge of robotics hardware (sensors and effectors) and software (programming and control strategies), what would you change in the exhibit/concert?

*OR*

* Dr. Oliver Lecture: Relate to *Vehicles* and Brooks [1986] &mdash; write about the ethology material from Dr. Oliver's lecture and relate it to the readings in Braitenber's *Vehicles* book and to Brooks' [1986] paper.

*A more complete specification for a "Meets Specification" (passing) A-Grade paper will be given during the semester.*
...
* Engineering Design Notebook Entry, Competition Project
* Engineering Design Notebook Entry, Weeks 10-16
* Robotics Technology in Everyday Life
...
* turn in a second *Vehicles* chapters 4-14 summary, notebook entry for weeks 10-16, or Robotics in Everyday Life analysis in an a single week
* revise and resubmit an assignment (up to a maximum of 3) that was judged "Does Not Meet Specification". Any work to be revised and resubmitted must have been submitted by the original due date.
...
**If you email me, please include “[CS-472]” in the subject line, so that my email program can correctly file your email and ensure that your message does not get buried in my general mailbox.**
...
***Unfortunately, we no longer have a dedicated lab/classroom space for this course. That means that we will have to move the equipment to/from the classroom for each class session.***

**The robotics equipment is stored in ST 110G.** I will make sure the room is unlocked before class begins.

**To get access to the equipment outside of class time, you will need to have the room unlocked.** It will generally be available M-F 8:15am-4:15pm. See the CS Department Secretary (Terri) or me to have the room opened for you.
...
## Space Availability
The following spaces are available for you to work outside of class time:

* The Robotics equipment room (ST 110G). There are two benches available in that room. You must not block access the equipment for other classmates.
* Classrooms &mdash; Free Times (Subject to Change)
    * ST 103
        * Mondays until 2:00pm and after 3:30pm
        * Wednesdays 9:30-11:30am and  after 3:30pm
        * Thursdays after 2:30pm
        * Fridays 9:30-11:30am and after 1:30pm
    * ST 105
        * Mondays 11:30am-12:20pm and after 1:30pm
        * Wednesdays after 3:30pm
        * Thursdays after 2:30pm
        * Fridays 8:30-9:20am, 11:30am-12:20pm, and after 1:30pm
    * ST 107
        * Mondays and Wednesdays after 3:30pm
        * Tuesdays and Thursdays 8:30-9:45pm, 11:30am-12:45pm, and after 2:30pm
        * Fridays 8:30-9:20am and after 12:30pm
    * The cubicle outside ST 110C.

***Please be considerate of other students and faculty in the ST 110 office area. Keep your noise levels down and do not block offices and walkways. If there are complaints, I will have to stop you from working in the office area.***
...
:-: | :-: | :-: | :-:
1 | 14 January 2020 | Lab 1 - *KIPR* Software Suite, *Wombat* Controller, *Create* robot base | Read *Vehicles* - Introduction, Chapters 1, 2, 3 and write summaries<br>Write Lab 1 Notebook Entry
2 | 21 January 2020 | Lab 2 - Light sensors, Braitenberg Vehicles | Read Miller [1993] and write summary<br>Write Lab 2 Notebook Entry
3 | 28 January 2020 | Lab 3 - Distance sensors, Multiprocessing | Read Brooks [1986] and write summary<br>Write Lab 3 Notebook Entry
4 | 4 February 2020 | Lab 4 - Servo motors, Subsumption Architecture | Write Lab 4 Notebook Entry
5 | 11 February 2020 | Lab 5 - Color vision processing | Write Lab 5 Notebook Entry
6 | 18 February 2020 | Lab 6 - Odds and Ends<br>Introduction of Competition Problem | Write Lab 6 Notebook Entry
7 | 25 February 2020 | Talk by Dr. Steven Oliver<br>Competition Problem Work
8 | 3 March 2020 | Competition
9 | 10 March 2020 | Final Project Work<br>(I will be at a conference)
Spring Break | 17 March 2020 | **No Class**
10 | 24 March 2020  | Final Project Work
11 | 31 March 2020 | Final Project Work
12 | 7 April 2020 | Final Project Work
13 | 14 April 2020 | Final Project Work
14 | 21 April 2020 | Final Project Work
15 | 28 April 2020 | Final Project Work
16 | 5 May 2020 | Final Project Work
Final Exams | ***Thursday***<br> 14 May 2020 | **Final Project Presentations**<br>8:30-11:30am
